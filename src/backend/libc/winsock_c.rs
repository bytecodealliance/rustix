...
pub(crate) use WinSock::{
    ADDRESS_FAMILY as sa_family_t, ADDRINFOA as addrinfo, IN_ADDR as in_addr, IN6_ADDR as in6_addr,
    IP_MREQ as ip_mreq, IPV6_MREQ as ipv6_mreq, LINGER as linger, SD_BOTH as SHUT_RDWR,
    ...
    WSA_E_CANCELLED as ECANCELED, WSAEACCES as EACCES, WSAEADDRINUSE as EADDRINUSE,
    WSAEADDRNOTAVAIL as EADDRNOTAVAIL, WSAEAFNOSUPPORT as EAFNOSUPPORT, WSAEALREADY as EALREADY,
    WSAEBADF as EBADF, WSAECONNABORTED as ECONNABORTED, WSAECONNREFUSED as ECONNREFUSED,
    ...
    WSAEWOULDBLOCK as EWOULDBLOCK, WSAEWOULDBLOCK as EAGAIN, WSAPOLLFD as pollfd, WSAPoll as poll,
    closesocket as close, ioctlsocket as ioctl, *,
};
